...
<html lang ="fr">
	...
	<section class="Bloc_Bt bloc_connexion "> 
		...
		if(!empty($mail) && !empty($mdp)){
			?>
			<span class="Jstransit2"style="color:red; text-shadow: 1px 2px 9px red; ">Aie, une erreur est survenue, <br> Vous avez pas les droits pour vous connecter...<br>Ceci est un site 'test' pour parcoursup (By Yanis Chiouar) </span><?php
